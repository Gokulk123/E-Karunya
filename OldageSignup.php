...
if (isset($_REQUEST['name'])) 
{
  ...
  mysqli_query($conn, "INSERT INTO `oldage` (`id`, `OrganisationName`, `email`, `mainphone`, `altphone`, `Address`, `regNo`, `careTakerName`, `careTakerPhone`, `password`, `status`) VALUES (NULL, '$name', '$email', '$phone', '$aPhone', '$address', '$regNo', '$careName', '$carePhone', '$pass', 'Suspend')");
  ...
  mysqli_query($conn,"INSERT INTO `accounts` (`Acc_id`, `Acc_owner`, `Acc_Owner_type`, `Acc_Balance`) VALUES (null, '$owner', '3', '10000')");
  ?>
      <script type="text/javascript">
