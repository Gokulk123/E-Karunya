            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="index.jsp"><i class="fa fa-dashboard fa-fw nav_icon"></i>HOME</a>
                        </li>
                        <li>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="#"><i class="fa fa-check-square-o nav_icon"></i>Booking<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Manage.jsp">Search Parking Space</a>
                                </li>
                                <li>
                                    <a href="booking.jsp">View Payment</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
