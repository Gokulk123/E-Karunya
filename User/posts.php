    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="posts.php" onclick="window.location='posts.php'" class="active">
      ...
      <table class="table table-striped table-advance table-hover">
        ...
        <tbody>
          <?php
              ...
              $sql = "SELECT posts.*,users.Name FROM `posts` INNER JOIN `users` ON `posts`.`OwnerId`=`users`.`id` WHERE `OwnerId`='".$_COOKIE['id']."'";
          ...
          <tr>
            ...
            <?php
              if ($row['Status']==1) {
                ...
                <td>
                  <a href="deletePosts.php?id=<?php echo $row['Post_id']; ?>">
