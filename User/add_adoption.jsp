  ...
  <div class="col-md-12">
    <div class="content-panel">
      <table class="table table-striped table-advance table-hover">
        <h4><i class="fa fa-angle-right"></i> Member Details For Adoption </h4>
        <hr>
        <thead>
          <tr>
...
{%>
          ...
          <tr>
            ...
            <td><% out.println(rs.getString("mem_orphan")); %></td>
             <td><% out.println(rs.getString("currentsts")); %></td>
           <td><a href="adoptionform.jsp?id=<%=rs.getString("mem_id")%>">Adopt</a></td>
            <%  
}
%> 						
    <%
