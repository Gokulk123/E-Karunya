...
<body>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="posts.php" onclick="widow.location='posts.php'" class="active">
 ...
 <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>Accept Donation</h4>
...
if(isset($_POST['submit']))
{
  ...
  echo $RegId.$OrgId.$Amount;
  $sql="INSERT INTO `donations`(`Donation_Org_Id`, `Donation_Amount`, `Donation_Req_Id`) VALUES ('$OrgId','$Amount','$ReqId')";
