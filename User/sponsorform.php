...
<body>
        ...
        <ul class="sidebar-menu" id="nav-accordion">
         ...
         <li class="mt">
          ...
          <li class="sub-menu">
           ...
           <li class="sub-menu">
            <a href="add_sponsor.php" class="active" >
              <i class="fa fa-tasks"></i>
 ...
 <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>Sponsorship Form</h4>
              <form class="form-horizontal style-form" method="post" action="sponsorform1.php" enctype="multipart/form-data">
