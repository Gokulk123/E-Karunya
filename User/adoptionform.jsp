      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
           ...
           <li class="sub-menu">
            <a class="active" href="add_adoption.jsp">
              <i class="fa fa-tasks"></i>
...
String orid=request.getParameter("id");
 ...
 <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>Adoption Form</h4>
              <form class="form-horizontal style-form" method="get" action="adoptionform1.jsp" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="orphid" value="<%=orid%>">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Date and Time</label>
                  <div class="col-sm-10">
