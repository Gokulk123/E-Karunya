...
<body>
  <div id="login-page">
    <div class="container">
      <form class="form-login" onsubmit="comparepasswords();">
...
try
   ...
   String sql="INSERT INTO `oldage`(`id`, `OrganisationName`, `email`, `mainphone`, `altphone`, `Address`, `regNo`, `careTakerName`, `careTakerPhone`, `password`, `status`) VALUES (null,'"+name+"','"+email+"','"+phone+"','"+aPhone+"','"+address+"','"+regNo+"','"+careName+"','"+carePhone+"','"+pass+"','0')";
