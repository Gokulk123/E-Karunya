...
<body>
 ...
 <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action="addDonation.php" enctype="multipart/form-data">
      ...
      <table class="table table-striped table-advance table-hover">
        ...
        <tbody>
          <?php
              ...
              $sql = "SELECT * FROM `donationrequest` WHERE `Donate_Org_Id`='".$_COOKIE['id']."'";
