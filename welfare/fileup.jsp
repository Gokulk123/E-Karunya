 ...
 for(int j = 0; j < cookies.length; j++)
  {
   ...
   cookieValue = cookie.getValue();
                    ...
                    PreparedStatement psmt = Con.prepareStatement ("UPDATE `productlist` SET `image`='"+fileName +"' WHERE `pro_id`='"+cookieValue+"'");                    int rows = psmt.executeUpdate();
                                       name=fileName;
                }
