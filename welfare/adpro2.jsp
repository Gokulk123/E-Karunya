...
String d=formatter.format(date);  
 ...
 <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Insert Your Product Image</h4>
                             
              
              <form class="form-horizontal style-form" method="post" action="fileup.jsp" enctype="multipart/form-data">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Upload Your Image : </label>
                  <div class="col-sm-10">
                      <input type="file" name="upload" class="logout" size="50">
                  </div>
                </div>
