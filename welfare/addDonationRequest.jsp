...
String d=formatter.format(date);  
 ...
 <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>Add Donation Request</h4>
              <form class="form-horizontal style-form" method="get" action="addDonation.jsp" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Organisaton Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="Organisaton">
                  </div>
                </div>
  ...
  <div class="col-md-12">
    <div class="content-panel">
      <table class="table table-striped table-advance table-hover">
        <h4><i class="fa fa-angle-right"></i> Donation Details </h4>
        <hr>
        <thead>
          <tr>
...
String query="SELECT * FROM `donationrequest` WHERE `Donate_Org_Id`='"+cookieid+"'";
...
{%>
          ...
          <tr>
            <td><% out.println(rs.getString("Donate_Id")); %></td>
            <td><% out.println(rs.getString("Donate_Date")); %></td>
            <td><% out.println(rs.getString("Donate_Name")); %></td>
            <td><% out.println(rs.getString("Donate_Report")); %></td>           
