...
if (isset($_REQUEST['name'])) 
{
  ...
  $type=$_REQUEST['type'];
    ...
    mysqli_query($conn, "INSERT INTO `orphanage` (`id`, `OrganisationName`, `email`, `mainphone`, `altphone`, `Address`, `regNo`, `careTakerName`, `careTakerPhone`, `password`, `status`) VALUES (NULL, '$name', '$email', '$phone', '$aPhone', '$address', '$regNo', '$careName', '$carePhone', '$pass', '0')");
