    ...
    <!-- **********************************************************************************************************************************************************
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <li class="mt">
          ...
          <li class="sub-menu">
            <a href="viewadoptionrequest.php">
              <i class="fa fa-tasks"></i>
...
?>
                  <tr>
                    ...
                    <?php
                      ...
                      {
                    ?>
                    <td><a href="viewproduct1.php?choice=approve&id=<?php echo  $row['pro_id']; ?>" style="color:green">Approve</a></td>
                    <?php
                      }
                      else
                      {
                    ?>
                      <td><a href="viewproduct1.php?choice=suspend&id=<?php echo  $row['pro_id']; ?>" style="color:orange">Suspend</a></td>
                      <?php } ?>
