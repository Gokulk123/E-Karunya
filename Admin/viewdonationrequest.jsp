                  ...
                  <tr>
                   ...
                   <td><center><%out.print(t.getString("sp_req_name"));%></center></td>
                    ...
                    <%
                      ...
                      {
                    %>
                    <td><a href="viewdonationrequest.jsp?choice=approve&id=<%out.print(id);%>" style="color:green">Approve</a></td>
                    <%
                      }
                      else
                      {
                    %>
                      <td><a href="viewdonationrequest.jsp?choice=suspend&id=<%out.print(id);%>" style="color:orange">Suspend</a></td>
                      <% } %>
...
if(type.equals("approve"))
          {
            sql1="UPDATE `sponsorrequest` SET `sp_request_status`='1' WHERE `Ad_Id`='"+id+"'";
            ...
            <script type="text/javascript">
                  ...
                  window.location="viewasponsorrequest.jsp";
                </script>
              <%
            }
            else
          ...
          {
            sql1="UPDATE `sponsorrequest` SET `sp_request_status`='0' WHERE `Ad_Id`='"+id+"'";
            PreparedStatement pmt=con.prepareStatement(sql1);
            int rs=pmt.executeUpdate();
            if(rs>0){
            %>
