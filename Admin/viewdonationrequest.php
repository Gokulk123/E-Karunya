              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th><i class="fa fa-bookmark"></i> Details</th>
                    <th><i class=" fa fa-calender"></i> Organisations</th>
...
?>
                  <tr>
                    <td><?php echo ++$i; ?></td>
                    <td><center><?php echo  $row['Donate_Name']; ?></center></td>
                    <td><center><?php echo  $row['Donate_Report']; ?></center></td>
                    <td><?php echo $row['Donate_Organisation']; ?></td>
                    <td>
                       <?php echo $row['Donate_Date']; ?>
                    </td>
                    
                    <?php
                      if($row['Donate_Status']=="Suspend")
                      {
                    ?>
                    <td><a href="viewdonationrequest.php?choice=approve&id=<?php echo  $row['Donate_Id']; ?>" style="color:green">Approve</a></td>
                    <?php
                      }
                      else
                      {
                    ?>
                      <td><a href="viewdonationrequest.php?choice=suspend&id=<?php echo  $row['Donate_Id']; ?>" style="color:orange">Suspend</a></td>
                      <?php } ?>
...
if(isset($_REQUEST['choice']))
{
 ...
 // echo $id.$type.$cat;
          ...
          if($type=="approve")
          {
            $sql="UPDATE `donationrequest` SET `Donate_Status`='Approve' WHERE `Donate_Id`='$id'";
            ...
            if($r)
            {
              ...
              ?>
                <script type="text/javascript">
                  ...
                  window.location="viewdonationrequest.php";
                </script>
              <?php
            }
            else
