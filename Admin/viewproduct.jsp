    ...
    <!-- **********************************************************************************************************************************************************
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <li class="mt">
          ...
          <li class="sub-menu">
            <a href="viewadoptionrequest.jsp">
              <i class="fa fa-tasks"></i>
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Seller Name</th>
                    <th> Product Name</th>
                    <th> Description</th>
                    <th>Actual Price</th>
...
?>
                  <tr>
                    ...
                    <td><center><?php echo  $row['pro_seller']; ?></center></td>
                    <td><center><?php echo  $row['pro_name']; ?></center></td>
                    <td><?php echo $row['pro_description']; ?></td>
                    <td>₹<?php echo $row['pro_actualprice']; ?></td>
                    <td>₹<?php echo $row['pro_discountprice']; ?></td>
                    ...
                    <?php
                      ...
                      {
                    ?>
                    <td><a href="viewproduct1.jsp?choice=approve&id=<?php echo  $row['pro_id']; ?>" style="color:green">Approve</a></td>
                    <?php
                      }
                      else
                      {
                    ?>
                      <td><a href="viewproduct1.jsp?choice=suspend&id=<?php echo  $row['pro_id']; ?>" style="color:orange">Suspend</a></td>
                      <?php } ?>
