    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <p style="text-align: center;color: white;text-transform: uppercase;">Old Age</p>
          <li class="mt">
...
String query="SELECT posts.*,users.Name FROM `posts` INNER JOIN `users` ON `posts`.`OwnerId`=`users`.`id` WHERE `posts`.`OwnerId`!='"+cookieid+"'";       
//$sql = "SELECT posts.*,users.Name FROM `posts` INNER JOIN `users` ON `posts`.`OwnerId`=`users`.`id` WHERE `posts`.`OwnerId`!='".$_COOKIE['id']."'";
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      ...
                      <button type="submit"
                              ...
                              '<% out.println(rs.getString("DateTime")); %>',
                              '<% out.println(rs.getString("Title")); %>',
                             ' <% out.println(rs.getString("Description")); %>',
                              ' <% out.println(rs.getString("Post_id")); %>'
