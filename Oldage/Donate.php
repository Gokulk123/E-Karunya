...
<body>
 ...
 <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action="DonationBackEnd.php">

<?php
print_r($_COOKIE);
          $sql = "SELECT * FROM `accounts` WHERE `Acc_id`='".$_COOKIE['id']."'";
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="RecId" value="<?php echo $row['id']; ?>">
