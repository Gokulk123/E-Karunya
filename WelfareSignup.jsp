...
try
   ...
   String sql="INSERT INTO `womenwelfare`(`id`, `OrganisationName`, `email`, `mainphone`, `altphone`, `Address`, `regNo`, `careTakerName`, `careTakerPhone`, `password`, `status`)"
    ...
    %>
    <script>
        alert("your request has been send please wait for the admin approval");
    </script>
         <%
    }
       }
