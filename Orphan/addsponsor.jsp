...
<body>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="addsponsor.jsp" class="active">
              <i class="fa fa-tasks"></i>
 ...
 <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>Add Members Details For Sponsorship</h4>
        ...
        if(request.getParameter("Submit")!=null)
    {
     ...
     String mre=request.getParameter("more");
      try
   {
Class.forName("com.mysql.jdbc.Driver");
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ekarunya","root","");
  String sql="INSERT INTO `sponsormember`(`sp_name`, `sp_age`, `sp_gender`,`sp_organ`,`sp_type`, `sp_moredtl`) VALUES ('"+name+"', '"+age+"', '"+gender+"','"+cookieValue+"','"+type+"','"+mre+"')";
...
<script type="text/javascript">
          ...
          window.location="addsponsor.jsp";
        </script>
<%
       }
   }
...
Class.forName("com.mysql.jdbc.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ekarunya","root","");
String query="SELECT * FROM `sponsormember`";
PreparedStatement psmt=con.prepareStatement(query);
ResultSet rs=psmt.executeQuery();
while(rs.next())
{%>
          <tr>
            <td><% out.println(rs.getString("sp_id")); %></td>
            <td><% out.println(rs.getString("sp_name")); %></td>
            <td><% out.println(rs.getString("sp_age")); %></td>
            <td><% out.println(rs.getString("sp_gender")); %></td>
            <td><% out.println(rs.getString("sp_type")); %></td>
            <td><% out.println(rs.getString("sp_moredtl")); %></td>
          </tr>
          <%
}
    rs.close();
