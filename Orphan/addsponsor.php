    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="addsponsor.php" class="active">
              <i class="fa fa-tasks"></i>
      ...
      <table class="table table-striped table-advance table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo $row['sp_age']; ?> </td>
            <td><?php echo $row['sp_gender']; ?> </td>
...
if (isset($_POST['submit'])) {
  $name    = $_REQUEST['name'];
              ...
              $type=$_REQUEST['type'];
    $r=mysqli_query($conn, "INSERT INTO `sponsormember`(`sp_name`, `sp_age`, `sp_gender`,`sp_type`) VALUES ('$name','$age','$gender','$type')");
    if ($r) {
      ?>
        <script type="text/javascript">
          alert("Member Details Added. ");
          window.location="addsponsor.php";
        </script>
