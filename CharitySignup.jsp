  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" onsubmit="return comparepasswords();">
        <h2 class="form-login-heading">Charity Signup</h2>
        <div class="login-wrap">
          ...
          <br>
          <input type="radio" name="type" value="orphan">Orphanage<br>
          <input type="radio" name="type" value="welfare">Women Welfare<br>
...
if (isset($_REQUEST['name'])) 
{
  ...
  //insert orphan details start here
  if ($type=='orphan') {



    mysqli_query($conn, "INSERT INTO `orphanage` (`id`, `OrganisationName`, `email`, `mainphone`, `altphone`, `Address`, `regNo`, `careTakerName`, `careTakerPhone`, `password`, `status`) VALUES (NULL, '$name', '$email', '$phone', '$aPhone', '$address', '$regNo', '$careName', '$carePhone', '$pass', '2')");
  $result = mysqli_query($conn, "SELECT * FROM `orphanage`");
  $owner=0;
  ...
  ?>
      <script type="text/javascript">
        ...
        window.location="CharityLogin.jsp";
      </script>
